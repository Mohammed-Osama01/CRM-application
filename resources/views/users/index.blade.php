...
<body>
    <div class="container m-5  pb-0">
        ...
        <a href="{{ route('dashboard.create') }}" class="btn btn-sm btn-primary mt-5 d-block w-25 ">Add New</a>
        <a href="{{ route('Client.trash') }}" class="btn btn-sm btn-primary mt-5 d-block w-25 ">Show Trash</a>
            ...
            <tbody>
                @foreach ($clients as $client)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dashboard.show', $client->id) }}" class="btn btn-sm btn-success"><i
                                    class="fas fa-eye"></i></a>
                            <a href="{{ route('dashboard.edit', $client->id) }}" class="btn btn-sm btn-primary"><i
                                    class="fas fa-edit"></i></a>
                            <button class="btn btn-sm btn-danger btn-delete"><i class="fas fa-trash"></i></button>
                            <form class="d-inline" action="{{ route('dashboard.destroy', $client->id) }}"
                                method="post">
                                @csrf
                                @method('delete')
